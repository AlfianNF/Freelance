...
<head>
    ...
    width: 100%; /* Menjadikan lebar img 100% dari parentnya (konten-bawah) */
    height: 100%; /* Menjadikan tinggi img 100% dari parentnya (konten-bawah) */
    object-fit: cover; /* Memastikan gambar mengisi konten tanpa merubah aspek rasionya */
    top: 0; /* Mengatur posisi img di atas konten */
    left: 0; /* Mengatur posisi img di kiri konten */
}
    </style>
</head>
            ...
            <div class="bawah-kanan">
                <div class="konten">
                    <div class="konten-atas">
                        <h2 class="teks">HALLO {{ $user->name }} , ada yang bisa kami bantu?</h2>
                    </div>
                    <div class="konten-bawah">
                        <div>
                            <img src="/gambar/pasien.gif" alt="">
                        </div>
                        
                        {{-- <div class="konten-bawah-kiri">
                            <div>
                                <input type="button" value="KONSULTASI DOKTER">
                            </div>
                        </div>
                        <div class="konten-bawah-kanan">
                            <div>
                                <input type="button" value="PEMERIKSAAN LAB">
                            </div>
                        </div> --}}
                    </div>
                </div>
