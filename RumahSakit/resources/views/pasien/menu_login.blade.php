...
<body>
    ...
    <div class="container">
        <div class="content">
            <div class="Login">
                <form class="form1" action="{{ route('login.pasien') }}" method="post">
                    @csrf
                    <h1 class="j1">RSUD</h1>
                    ...
                    <div class="fitur-bawah">
                        <p>Anda belum punya akun? <a id="" href="/register/pasien" class="fitur-buatAkun">Buat Akun Baru</a></p>
                    </div>
                </form>
                
            </div>
            <div class="gambar-container">
                <img src="/gambar/gambar2.png" alt="">
            </div>
        </div>
    </div>
