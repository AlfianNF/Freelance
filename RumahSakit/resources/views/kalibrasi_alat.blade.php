    ...
    <div class="Dasar">
      <div class="kiri">
        ...
        <div class="bawah-kiri">
          ...
          ><br />
          <a href="kalibrasi_alat.html" class="aktif_btn">
                  ...
                  <div class="border">
                    <table class="table1">
                      <tr>
                        ...
                        <td style="width: 30%"><span class="text">:</span><input type="text" class="input1" placeholder="" /></td>
                        <td style="width: 15%"><span class="text">Tanggal Kalibrasi</span></td>
                        <td style="width: 30%"><span class="text">:</span><input type="text" class="input1" placeholder="" /></td>
                      </tr>
                      <tr>
                        <td><span class="text">Nama Alat</span></td>
                        <td><span class="text">:</span><input type="text" class="input1" placeholder="" /></td>
                        <td><span class="text">Tanggal Kalibrasi Berikutnya</span></td>
                        <td><span class="text">:</span><input type="text" class="input1" placeholder="" /></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td><span class="text">Interval Kalibrasi</span></td>
                        <td><span class="text">:</span><input type="text" class="input1" placeholder="" /></td>
                      </tr>
                    </table>
                    <a href="">
